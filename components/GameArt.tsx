/* ============================================================
   ...
   Two modes:
   • `thumb` set  → render that image. Almost every game has one:
     the icon pack under public/games/icons/, wired up by
     scripts/gen_catalogue.py. See public/games/README.md for how a
     tile is fitted, and for the licensed-CDN route.
   • no `thumb`   → build a layered SVG from the game id, so every
     tile is distinct, deterministic and ours.
   ============================================================ */
...
/** See GameIcon: rounding keeps server and client markup byte-identical. */
  ...
  return (
    <div className="game__art">
      <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" aria-hidden>
        ...
        {/* sparkles — deterministic positions so server and client agree */}
        <g fill="#fff">
